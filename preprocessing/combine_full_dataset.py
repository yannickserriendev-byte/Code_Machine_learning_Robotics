"""
Preprocessing utility to combine all trial folders into a single full dataset.

- Use create_full_dataset() to merge images and labels from multiple trials into one dataset.
- Output: '0.images' folder with all images, and '0.labels.csv' with all labels and metadata.
- Adjust base_dir and output_dir for your data locations.
"""
...
if __name__ == "__main__":
    base_directory = r"Y:\Master Thesis\Sensor_1\Crisp data\Data"
